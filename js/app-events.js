...
$( document ).ready(function() {
    ...
    $(".container").mouseover(function(){
        $(`.titulo`).css({"font-size":"2.5rem","display":"flex","justify-content":"center","background-size":"35% 5%",
        "color":"black","text-shadow":"0 2px 1px grey"}) 
        $(".descripcion").css({"font-weight":"400","opacity":"1"})
        $(".titulo_pez").fadeIn(1500)
    })
    ...
    $(".titulo_pez").mouseover(function(){
        ...
        $(".titulo_pez").animate("color","yellow")
    ...
    $("#form_mail").submit((function(e){
        e.preventDefault()
            ...
            //Captura de las respuestas del jugador
            for (let i = 0; i < 5; i++) {
                let x=$(`.fila${i} select`)
